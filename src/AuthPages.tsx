    ...
    <Page themed>
      <main className="account-page account-redesign">
        ...
        <section className="account-lower-grid">
          ...
          <div className="account-side-stack"><Card className="account-section preferences-section" aria-labelledby="preferences-title"><header><div><span className="section-kicker">Preferences</span><h2 id="preferences-title">Your workspace</h2></div></header><div className="preferences-grid"><article><div><h3>Theme</h3><p>Follow your device or choose an appearance.</p></div><ThemeControl /></article><article><div><h3>Motion</h3><p>Reduce transitions and automatic model rotation.</p></div><MotionControl /></article></div></Card><Card className="account-section voice-privacy"><span className="section-kicker"><Volume2 size={15} />Voice privacy</span><p>Your microphone is used only while a Voice session runs. Live captions and raw audio are not stored by Stranerd.</p><a href="/legal/privacy">Read privacy policy<ArrowRight size={13} /></a></Card><Card className="account-section data-controls"><span className="section-kicker">Your data</span><p>Request permanent deletion of your account and associated data through support.</p><Button variant="outline" asChild><a href="mailto:officialstranerd@gmail.com?subject=Stranerd%20account%20deletion%20request">Request deletion<ExternalLink size={14} /></a></Button></Card></div>
        </section>
      </main>
    </Page>
  );
