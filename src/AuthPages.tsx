...
export function AccountPage() {
  ...
  const subscriptionRail = billingOptions?.rails.subscription[0];
  const packRail = nigeria ? billingOptions?.rails.payg_100.find((rail) => rail === "ngn") : billingOptions?.rails.payg_100.find((rail) => rail === "usd_card");
