...
import { ArrowLeft, ArrowRight, BookOpen, Check, ClipboardList, GalleryVerticalEnd, LayoutGrid, Lightbulb, Sparkles } from 'lucide-react'
...
export function LibraryView({ onMaterialGrade, onMaterialProgress, onModeChange, onNoteContext, onNoteRequest, onMaterialLearningState, onMaterialLearningController, onBalance, onInsufficientCredits, onSignIn, signedIn, creditBalance, flashcardProgressByDeck, materialProgressByRelease }: LibraryProps) {
...
export function QuizzesView({ model, quizzes, quizIndex, answers, submitted, hints, corrections, loadingHintIndex, loadingCorrections, onQuiz, onAnswer, onSubmit, onHint, onCorrections, aiError, aiNeedsCredits, signedIn, onBack }: QuizProps) {
