...
export function LibraryView({ onMaterialGrade, onModeChange, onNoteContext, onNoteRequest, onMaterialLearningState, onMaterialLearningController, onBalance, onInsufficientCredits, onSignIn, signedIn, creditBalance, flashcardProgressByDeck }: LibraryProps) {
